...
class ProductsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate, SwipeTableViewCellDelegate {
    ...
    override func viewDidLoad() {
        ...
        disclaimerAttributedString.addAttribute(NSAttributedString.Key.foregroundColor, value: UIColor.red, range: NSRange(location: 0, length: 10))
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let firstYearMutableString = NSMutableAttributedString(string: firstYearString, attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: fontSize)])
        cell.firstYearPrice.attributedText = firstYearMutableString
        cell.firstYearDiscountedPrice.attributedText = NSMutableAttributedString(string: "Disc.\nPrice ($)", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: fontSize)])
        ...
        cell.productName.setAttributedTitle(NSMutableAttributedString(string: (cell.productName.titleLabel?.text)!, attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: fontSize)]), for: .normal)
        cell.location.setAttributedTitle(NSMutableAttributedString(string: (cell.location.titleLabel?.text)!, attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: fontSize)]), for: .normal)
        cell.color.attributedText = NSMutableAttributedString(string: cell.color.text!, attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: fontSize)])
        cell.quantity.attributedText = NSMutableAttributedString(string: cell.quantity.text!, attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: fontSize)])
